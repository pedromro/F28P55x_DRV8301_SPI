...
static volatile uint16_t latest_status1_data11 = 0;
static void on_status1_read(uint16_t raw, uint16_t data11, void *user)
{
    (void)raw; (void)user;
    latest_status1_data11 = data11;
}

static volatile uint16_t latest_status2_data11 = 0;
static void on_status2_read(uint16_t raw, uint16_t data11, void *user)
{
    (void)raw; (void)user;
    latest_status2_data11 = data11;
}
...
int main(void)
{
    ...
    // DRV8301_queueRead(DRV8301_REG_STATUS1, on_status1_read  , 0);

    DRV8301_queueRead(DRV8301_REG_STATUS2, on_status2_read  , 0);
